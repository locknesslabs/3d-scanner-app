...
class SIWESampleWebService {
  ...
  Future<Map<String, dynamic>> getNonce() async {
    try {
      final response = await http.get(
        Uri.parse('${DartDefines.apiUrl}/auth/nonce'),
        headers: _headers,
      );
  ...
  Future<Map<String, dynamic>> getSession() async {
    try {
      await _checkHeaders();
      final response = await http.get(
        Uri.parse('${DartDefines.apiUrl}/auth/me'),
        headers: _headers,
      );
  ...
  Future<Map<String, dynamic>> verifyMessage(
    ...
    try {
      final uri = Uri.parse('${DartDefines.apiUrl}/auth/authenticate');
  ...
  Future<Map<String, dynamic>> updateUser(Map<String, dynamic> data) async {
    try {
      final response = await http.post(
        Uri.parse('${DartDefines.apiUrl}/auth/update-user'),
        headers: _headers,
  ...
  Future<Map<String, dynamic>> signOut() async {
    try {
      final response = await http.post(
        Uri.parse('${DartDefines.apiUrl}/auth/sign-out'),
        headers: _headers,
      );
