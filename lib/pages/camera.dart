...
class CameraResult {
  CameraResult(this.isVideo, this.file);
...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  disposePage(VoidCallback doneCallback) async {
    final CameraController? cameraController = controller;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (showFocusCircle)
            Positioned(
              top: focusPoint.dy * MediaQuery.of(context).size.height - 20,
              left: focusPoint.dx * MediaQuery.of(context).size.width - 20,
              child: Container(
                height: 40,
                width: 40,
                decoration: BoxDecoration(
  ...
  switchCamera() {
    ...
    if (controller!.description.lensDirection == CameraLensDirection.front) {
      onNewCameraSelected(_cameras.firstWhere((description) =>
  ...
  Widget recordVideoWidget() {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
          color: Colors.red,
          shape: cameraController.value.isRecordingVideo
              ? BoxShape.rectangle
              : BoxShape.circle,
        ));
  }
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) {
      if (mounted) {
        ...
        if (file != null) {
          disposePage(() {
            Navigator.pop(context, CameraResult(false, file));
          });
        }
      }
    });
  ...
  void onStopButtonPressed(context) {
    stopVideoRecording().then((XFile? file) {
      ...
      if (file != null) {
        ...
        //
        disposePage(() {
          Navigator.pop(context, CameraResult(true, file));
        });
      }
    });
  }
